Na quarta aula, através do Codepen, iniciou-se o desenvolvimento do código em JavaScript do app de transporte semelhante ao Uber/99 Taxi.

Debateu-se ainda o conceito de concatenação no código.
