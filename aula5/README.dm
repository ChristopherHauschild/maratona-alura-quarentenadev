Na quinta aula, iniciou-se o desenvolvimento em HTML e CSS de um curriculum visando para aprendizado que será posteriormente empregado no certificado online.
